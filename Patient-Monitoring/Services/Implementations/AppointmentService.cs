...
namespace Patient_Monitoring.Services.Implementations
{
    public class AppointmentService : IAppointmentService
    {
        ...
        public async Task<IActionResult> BookSlotAsync(AppointmentBookingDto bookingDto)
        {
            ...
            string newAppointmentId = await GenerateNextAppointmentId();
        ...
        public async Task<ActionResult<object>> GetPatientAppointmentsByStatusAsync(string patientId)
        {
        ...
        public async Task<ActionResult<IEnumerable<PastAppointmentDto>>> GetPastAppointmentsAsync(string patientId)
        {
        ...
        public async Task<ActionResult<object>> GetDoctorMetricsAsync(string doctorId)
        {
            var today = DateTime.Today;
        ...
        public async Task<ActionResult<IEnumerable<PendingApprovalDto>>> GetPendingApprovalsAsync(string doctorId)
        {
        ...
        public async Task<ActionResult<IEnumerable<DoctorSlotViewDto>>> GetDoctorScheduleAsync(string doctorId, DateTime date)
        {
        ...
        public async Task<ActionResult<object>> GetWeeklyScheduleSummaryAsync(string doctorId)
        {
