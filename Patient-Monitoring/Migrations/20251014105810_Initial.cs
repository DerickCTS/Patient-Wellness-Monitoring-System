        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiseaseDescription = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedByDoctorId = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PlanId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AssignedByDoctorId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PatientPlanAssignments_Doctors_AssignedByDoctorId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PatientPlanAssignments_WellnessPlans_PlanId",
                        column: x => x.PlanId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WellnessPlanDetails_WellnessPlans_PlanId",
                        column: x => x.PlanId,
                        principalTable: "WellnessPlans",
                        principalColumn: "PlanId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PrescribingDoctorId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Prescriptions_Doctors_PrescribingDoctorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AssignmentPlanDetails_PatientPlanAssignments_AssignmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientPlanAssignmentId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskLogs", x => x.LogId);
                    table.ForeignKey(
                        name: "FK_TaskLogs_PatientPlanAssignments_PatientPlanAssignmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssignmentPlanDetails_AssignmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientPlanAssignments_AssignedByDoctorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientPlanAssignments_PlanId",
                table: "PatientPlanAssignments",
                column: "PlanId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prescriptions_PrescribingDoctorId",
                table: "Prescriptions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskLogs_PatientPlanAssignmentId",
                table: "TaskLogs",
                column: "PatientPlanAssignmentId");

            migrationBuilder.CreateIndex(
                name: "IX_WellnessPlanDetails_PlanId",
