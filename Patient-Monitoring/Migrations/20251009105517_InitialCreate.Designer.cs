...
namespace Patient_Monitoring.Migrations
{
    ...
    [Migration("20251009105517_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Patient_Monitoring.Models.AppointmentAlert", b =>
                {
            ...
            modelBuilder.Entity("Patient_Monitoring.Models.PatientPlanAssignment", b =>
                {
                    ...
                    b.Property<string>("AssigningDoctorDoctorID")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("AssigningDoctorDoctorID");
            ...
            modelBuilder.Entity("Patient_Monitoring.Models.Appointment", b =>
                {
                    b.HasOne("Patient_Monitoring.Models.Doctor", null)
                        .WithMany("Appointments")
                        .HasForeignKey("DoctorID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Patient_Monitoring.Models.Patient", null)
                        .WithMany("Appointments")
            ...
            modelBuilder.Entity("Patient_Monitoring.Models.PatientPlanAssignment", b =>
                {
                    ...
                    b.HasOne("Patient_Monitoring.Models.Doctor", "AssigningDoctor")
                        ...
                        .HasForeignKey("AssigningDoctorDoctorID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
