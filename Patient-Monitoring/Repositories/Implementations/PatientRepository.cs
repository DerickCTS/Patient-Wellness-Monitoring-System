...
namespace Patient_Monitoring.Repositories.Implementations
{
    public class PatientRepository : IPatientRepository
    {
        ...
        public async Task<bool> AddNewPatientAsync(Patient patient)
        {
        ...
        //❌ Yet to Confirm
        public async Task<List<Patient>> SearchPatientsByIdOrNameAsync(string? patientName, int? patientId)
        {
        ...
        public async Task<bool> IsDoctorAssigned(int patientId, int doctorId)
        {
        ...
        public async Task<Diagnosis> GetDiagnosisWithDiseaseAsync(int diagnosisId)
        {
